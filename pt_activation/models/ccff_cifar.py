...
class CCFF(nn.Module):
    def __init__(self, num_classes=10):
        ...
        self.c1 = nn.Conv2d(3, 5, kernel_size=5, stride=1, bias=False)
        self.c2 = nn.Conv2d(5, 10, kernel_size=3, stride=1, bias=False)
        
        self.l1 = nn.Linear(6760, 256, bias=False)
