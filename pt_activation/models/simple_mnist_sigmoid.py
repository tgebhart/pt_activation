...
from pt_activation.functions.filtration import linear_filtration, conv_filtration

class CFF(nn.Module):
    def __init__(self, filters=3, kernel_size=8, fc1_size=50):
    ...
    def forward(self, x, hiddens=False):
        ...
        h1_m = torch.sigmoid(self.conv1(x))
    ...
    def compute_dynamic_filtration(self, x, hiddens, percentile=None):
        ...
        # mat = conv_layer_as_matrix(self.conv1.weight.data, x, self.conv1.stride[0])
        # x = x.cpu().detach().numpy().reshape(-1)
